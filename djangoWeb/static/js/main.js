...
var hotHandsontable,hotHandsontableData;
...
var _onsheet = function(json, cols, sheetnames, select_sheet_cb) {
  ...
  calculateSize();
  hotHandsontableData = json;
  /* showtime! */
//testHandson = $("#hot").handsontable({
	hotHandsontable = new Handsontable(document.getElementById('hot'),{
		readOnly: true,
    data: json,
    startRows: 5,
    startCols: 3,
